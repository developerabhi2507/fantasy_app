...
//
//     final userMatchFixtureRecord = userMatchFixtureRecordFromJson(jsonString);

import 'dart:convert';

UserMatchFixtureRecord userMatchFixtureRecordFromJson(String str) =>
    UserMatchFixtureRecord.fromJson(json.decode(str));

String userMatchFixtureRecordToJson(UserMatchFixtureRecord data) =>
    json.encode(data.toJson());

class UserMatchFixtureRecord {
  UserMatchFixtureRecord({
  ...
  factory UserMatchFixtureRecord.fromJson(Map<String, dynamic> json) =>
      UserMatchFixtureRecord(
        status: json["status"],
