...
//
//     final userMatchResultRecord = userMatchResultRecordFromJson(jsonString);

import 'dart:convert';

UserMatchResultRecord userMatchResultRecordFromJson(String str) =>
    UserMatchResultRecord.fromJson(json.decode(str));

String userMatchResultRecordToJson(UserMatchResultRecord data) =>
    json.encode(data.toJson());

class UserMatchResultRecord {
  UserMatchResultRecord({
  ...
  factory UserMatchResultRecord.fromJson(Map<String, dynamic> json) =>
      UserMatchResultRecord(
        status: json["status"],
