...
class _PlayingHistoryState extends State<PlayingHistory> {
  ...
  void getUserData() async {
    ...
    await authController.playingHistoryRecord();
    // var responseData = ApiProvider().getProfile();
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(
                        '${authController.playingHistory?.data.contest}',
                        style: TextStyle(
                          fontFamily: 'Poppins',
                        ),
                      ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(
                        '${authController.playingHistory?.data.matchs}',
                        style: TextStyle(
                          fontFamily: 'Poppins',
                        ),
                      ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(
                        '${authController.playingHistory?.data.series}',
                        style: TextStyle(
                          fontFamily: 'Poppins',
                        ),
                      ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(
                        '${authController.playingHistory?.data.wins}',
                        style: TextStyle(
                          fontFamily: 'Poppins',
                        ),
                      ),
