...
class _ContestsScreenState extends State<ContestsScreen> {
                ...
                child: Stack(
                  ...
                  children: [
                    ListView.builder(
                      ...
                      itemCount: authController.contestList?.data.length,
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    authController
                                        .contestList!.data[index].contestName,
                                    style: TextStyle(
                                      fontFamily: 'Poppins',
                                      color: AllCoustomTheme.getThemeData()
                                          .primaryColor,
                          ...
                          content: Padding(
                            ...
                            child: Column(
                              children: List.generate(
                                  ...
                                  (index) => contestnt(
                                      authController
                                          .contestList!.data[index].prizePool,
                                      authController
                                          .contestList!.data[index].entry,
                                      '${int.parse(authController.contestList!.data[index].totalTeam) - int.parse(authController.contestList!.data[index].joinTeam)} ',
                                      '${authController.contestList!.data[index].totalTeam}',
                                      authController
                                          .contestList!.data[index].winners,
                                      double.parse(authController.contestList!
                                              .data[index].joinTeam) *
                                          100 /
  ...
  Future<void> setshowDialog(String entryFee) async {
                        ...
                        child: Container(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              borderRadius: new BorderRadius.circular(4.0),
                              onTap: () async {
                                // await authController.myContestsListRecord();
                                Navigator.pop(context);
                              },
                              child: Center(
                                child: Text(
